import { Zap, TrendingDown, BarChart3, Brain, Leaf, MapPin, ArrowRight, Activity } from 'lucide-react';
...
export default function LandingPage({ onNavigate }: LandingPageProps) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <nav className="border-b border-slate-200 bg-white/80 backdrop-blur-md fixed w-full z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-slate-900">Smart Campus Energy</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex gap-4">
                <button
                  onClick={onNavigate}
                  className="px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium flex items-center gap-2 shadow-lg shadow-blue-600/30"
                >
                  View Dashboard <ArrowRight className="w-5 h-5" />
                </button>
                <button className="px-8 py-4 border-2 border-slate-200 text-slate-700 rounded-lg hover:border-slate-300 transition font-medium">
                  Learn More
                </button>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-blue-600">847 kW</div>
      ...
      <section id="impact" className="py-20 bg-white border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Our Impact This Month</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">24,580 kWh</div>
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">8.4 Tons</div>
            ...
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-slate-900 mb-2">32 Buildings</div>
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Comprehensive Energy Intelligence</h2>
