  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <main className="ml-64 flex-1 p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Energy Dashboard</h1>
          <p className="text-slate-600">Real-time monitoring and insights across campus facilities</p>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            ...
            <div className="text-2xl font-bold text-slate-900 mb-1">1,425 kWh</div>
            <div className="text-sm text-slate-600">Total Energy Today</div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            ...
            <div className="text-2xl font-bold text-slate-900 mb-1">847 kW</div>
            <div className="text-sm text-slate-600">Current Load</div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            ...
            <div className="text-2xl font-bold text-slate-900 mb-1">14:30</div>
            <div className="text-sm text-slate-600">Peak Usage Time</div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            ...
            <div className="text-sm text-slate-600">System Efficiency</div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-slate-900">Real-Time Energy Usage</h2>
              <div className="flex gap-2">
                <button className="px-3 py-1 text-sm bg-blue-50 text-blue-600 rounded-lg font-medium">Electricity</button>
                <button className="px-3 py-1 text-sm text-slate-600 hover:bg-slate-50 rounded-lg">Water</button>
                <button className="px-3 py-1 text-sm text-slate-600 hover:bg-slate-50 rounded-lg">Gas</button>
              </div>
            </div>
            ...
            <div className="h-64 flex items-end gap-2">
              {[
                ...
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  ...
                  />
                  <span className="text-xs text-slate-500 mt-1">{data.hour}</span>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            <h2 className="text-lg font-bold text-slate-900 mb-6">Resource Distribution</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold text-slate-900">Building Overview</h2>
            ...
            <div className="space-y-3">
              {buildings.map((building, i) => (
                <div key={i} className="flex items-center justify-between p-4 rounded-lg hover:bg-slate-50 transition group cursor-pointer">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-slate-500">{building.usage} kW</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className={`flex items-center gap-1 text-sm font-medium ${
                      ...
                      {building.change > 0 ? <TrendingUp className="w-4 h-4" /> : <TrendingDown className="w-4 h-4" />}
          ...
          <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            ...
            <div className="space-y-3">
              {alerts.map((alert, i) => (
                <div key={i} className="flex gap-4 p-4 rounded-lg hover:bg-slate-50 transition cursor-pointer">
                  ...
                  <div className="flex-1">
                    <div className="font-medium text-slate-900 mb-1">{alert.building}</div>
                    <div className="text-sm text-slate-600 mb-2">{alert.message}</div>
